 ...
 */
export const resolveAutoSidebarItems = (headingDepth) => {
    ...
    const handleChildItem = (item, pathPrefix = prefix) => {
        ...
        if ("children" in childItem) {
            ...
            return {
                type: "group",
                ...childItem,
                children: childItem.children === "structure"
...
export const resolveSidebarItems = () => {
    ...
    const sidebarConfig = frontmatter.value.home
        ? false
        : (_b = (_a = frontmatter.value.sidebar) !== null && _a !== void 0 ? _a : themeLocale.value.sidebar) !== null && _b !== void 0 ? _b : "auto";
