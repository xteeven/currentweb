...
const themeHope = ({ plugins = {}, ...themeOptions }, app) => {
    ...
    return {
        ...
        onPrepared: () => Promise.all([
            (0, sidebar_1.prepareSidebarData)(app, themeOptions),
            (0, themeColor_1.prepareThemeColorScss)(app, themeOptions),
        ]).then(() => void 0),
