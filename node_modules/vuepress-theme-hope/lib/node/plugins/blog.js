...
exports.resolveBlogPlugin = exports.getTitleLocales = exports.getBlogOptions = void 0;
...
const resolveBlogPlugin = (themeData, options) => {
    if (!options)
        return ["", false];
    const blogOptions = {
        ...defaultOptions,
    ...
    return (0, vuepress_plugin_blog2_1.blog)({
        metaScope: "",
...
exports.resolveBlogPlugin = resolveBlogPlugin;
