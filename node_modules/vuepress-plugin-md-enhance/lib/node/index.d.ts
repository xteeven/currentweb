...
declare const mdEnhancePlugin: Plugin<MarkdownEnhanceOptions>;
declare const mdEnhance: (options: MarkdownEnhanceOptions | false) => PluginConfig<MarkdownEnhanceOptions>;

export { CodeDemoOptions, MarkdownContainerName, MarkdownEnhanceLocaleConfig, MarkdownEnhanceLocaleData, MarkdownEnhanceOptions, PresentationOptions, RevealPlugin, TaskListOptions, mdEnhancePlugin as default, mdEnhance, mdEnhancePlugin };
