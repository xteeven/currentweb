...
const theses = [
  ...
  { code: 'Master', title: 'Jieying Zhang — Is it Me? Toward Self-Extension to AI Avatars in Virtual Reality (University of Amsterdam, Amsterdam, Netherlands)', year: '2026' },
