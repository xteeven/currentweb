import{_ as J}from"./plugin-vue_export-helper-DlAUqK2U.js";import{l as Q,d as U,c as o,i as g,b as u,a as s,h as X,u as j,e as I,o as $,_ as w,t as Y,g as f,f as Z}from"./light-BpPH0lfg.js";import{f as M,h as a,p as ee,i as te,g as _,D as b,o as h,w as c,c as T,F as B,C as k,B as m,e as y,a as C,b as N,t as S}from"./app-CyE3xLar.js";import{b as ie}from"./replaceable-B6JXjP7_.js";import{N as ne}from"./Space-BCJKZ8A6.js";import{N as oe}from"./Card-BQ0uB-ps.js";import{N as P}from"./Tag-D4qZ3RN0.js";import"./Close-CF8CASon.js";import"./Icon-B8bgCZ_1.js";import"./color-to-class-B0iQgAn2.js";let F=!1;function re(){if(Q&&window.CSS&&!F&&(F=!0,"registerProperty"in(window==null?void 0:window.CSS)))try{CSS.registerProperty({name:"--n-color-start",syntax:"<color>",inherits:!1,initialValue:"#0000"}),CSS.registerProperty({name:"--n-color-end",syntax:"<color>",inherits:!1,initialValue:"#0000"})}catch{}}const le={titleMarginMedium:"0 0 6px 0",titleMarginLarge:"-2px 0 6px 0",titleFontSizeMedium:"14px",titleFontSizeLarge:"16px",iconSizeMedium:"14px",iconSizeLarge:"14px"};function se(t){const{textColor3:r,infoColor:n,errorColor:i,successColor:e,warningColor:l,textColor1:d,textColor2:p,railColor:v,fontWeightStrong:z,fontSize:x}=t;return Object.assign(Object.assign({},le),{contentFontSize:x,titleFontWeight:z,circleBorder:`2px solid ${r}`,circleBorderInfo:`2px solid ${n}`,circleBorderError:`2px solid ${i}`,circleBorderSuccess:`2px solid ${e}`,circleBorderWarning:`2px solid ${l}`,iconColor:r,iconColorInfo:n,iconColorError:i,iconColorSuccess:e,iconColorWarning:l,titleTextColor:d,contentTextColor:p,metaTextColor:r,lineColor:v})}const ae={common:U,self:se},R=1.25,ce=o("timeline",`
 position: relative;
 width: 100%;
 display: flex;
