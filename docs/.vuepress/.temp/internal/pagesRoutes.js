...
const routeItems = [
  ...
  ["v-96536bf0","/contact/",{"title":"Social","type":"article","readingTime":{"minutes":0.32,"words":96},"excerpt":"Social Tweets by Xteeven Other Networks Google Scholar Researchgate Linkedin Github Instagram Contact Mail\r\" steeven.villa[at]ifi.lmu.de \"\r\" D.Villa[at]lmu.de\" Phones\r\" +33 7 6634 "},["/contact/index.html","/contact/README.md"]],
  ...
  ["v-13c33eef","/publications/",{"title":"Publications","type":"article","readingTime":{"minutes":0.14,"words":42},"excerpt":"Publications <Paper v-for=\"paper in posts\" :year=\"paper.id\" :title=\"paper.title\" /> export default { // ... data() { return { posts: [ { id: 1, title: 'My journey with Vue' }, { id"},["/publications/index.html","/publications/README.md"]],
  ["v-7616c71b","/research/",{"title":"Research","type":"article","readingTime":{"minutes":2.27,"words":681},"excerpt":"Research [//]: # (Todo: add timeline style) Master's and Bachelor's thesis topics: --- If you are interested send me an email or contact me via the MIMUC slack workspace :mask: Cur"},["/research/index.html","/research/README.md"]],
